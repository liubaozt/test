...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="editor-field">
      ...
      <%--  <div class="AssetsEntryColumn3">
         ...
         <div class="AssetsEntryColumn3">
            <%:Html.AppLabelFor(m => m.PanDianHao, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.PanDianHao, Model.PageId, "AssetsEntry")%>
        </div>
        <%:Html.ValidationMessageFor(m => m.DepartmentId)%>
        <%:Html.ValidationMessageFor(m => m.StoreSiteId)%>
<%--        <%:Html.ValidationMessageFor(m => m.PurchaseTypeId)%>--%>
      <%:Html.ValidationMessageFor(m => m.PanDianHao)%>
    </div>
    <div class="editor-field">
        <div class="AssetsEntryColumn1">
        ...
        <div class="AssetsEntryColumn2">
         ...
         <div class="AssetsEntryColumn1">
            <%:Html.AppLabelFor(m => m.MarkMK, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.MarkMK, Model.PageId, "AssetsEntry")%>
        </div>
      <%--  <div class="AssetsEntryColumn3">
        ...
        <%:Html.ValidationMessageFor(m => m.MarkMK)%>
        <%--<%if (AppMember.DepreciationRuleOpen)
          { %>
    ...
    <div class="editor-field">
        ...
        <%:Html.ValidationMessageFor(m => m.AssetsQty)%>
    </div>
<%--    <%if (!AppMember.DepreciationRuleOpen)
      { %>
    <div class="editor-field">
   ...
   <%-- <div class="editor-field">
    ...
    <div class="editor-field">
        <div class="AssetsEntryColumn1">
            <%:Html.AppLabelFor(m => m.CEANo, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.CEANo, Model.PageId, "AssetsEntry")%>
        </div>
        <div class="AssetsEntryColumn2">
            <%:Html.AppLabelFor(m => m.TagMaterial, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.TagMaterial, Model.PageId, "AssetsEntry")%>
        </div>
         <div class="AssetsEntryColumn3">
        ...
        <%:Html.ValidationMessageFor(m => m.CEANo)%>
        <%:Html.ValidationMessageFor(m => m.TagMaterial)%>
        <%:Html.ValidationMessageFor(m => m.Remark)%>
    </div>
    <div class="editor-field">
       
        <div class="AssetsEntryColumn1">
            <%:Html.AppLabelFor(m => m.MujuNo, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.MujuNo, Model.PageId, "AssetsEntry")%>
        </div>
        <div class="AssetsEntryColumn2">
            <%:Html.AppLabelFor(m => m.ShengchanhuopinNo, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.ShengchanhuopinNo, Model.PageId, "AssetsEntry")%>
        </div>
         <div class="AssetsEntryColumn3">
            <%:Html.AppLabelFor(m => m.Mujuxueshu, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.Mujuxueshu, Model.PageId, "AssetsEntry")%>
        </div>
        <%:Html.ValidationMessageFor(m => m.MujuNo)%>
        <%:Html.ValidationMessageFor(m => m.ShengchanhuopinNo)%>
        <%:Html.ValidationMessageFor(m => m.Mujuxueshu)%>
    </div>
    <div class="editor-field">
       
        <div class="AssetsEntryColumn1">
            <%:Html.AppLabelFor(m => m.Mujushouming, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.Mujushouming, Model.PageId, "AssetsEntry")%>
        </div>
        <div class="AssetsEntryColumn2">
            <%:Html.AppLabelFor(m => m.Shejichannenng, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.Shejichannenng, Model.PageId, "AssetsEntry")%>
        </div>
        <div class="AssetsEntryColumn1">
            <%:Html.AppLabelFor(m => m.Hadshejichannneng, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.Hadshejichannneng, Model.PageId, "AssetsEntry")%>
        </div>
        <%:Html.ValidationMessageFor(m => m.Mujushouming)%>
        <%:Html.ValidationMessageFor(m => m.Shejichannenng)%>  
        <%:Html.ValidationMessageFor(m => m.Hadshejichannneng)%>
    </div>
    <div class="editor-field">       
      <%--  <div class="AssetsEntryColumn2">
            <%:Html.AppLabelFor(m => m.ShiYongDiDian, Model.PageId, "AssetsEntry")%>
            <%:Html.AppTextBoxFor(m => m.ShiYongDiDian, Model.PageId, "AssetsEntry")%>
        </div>--%>
       <%-- <%:Html.ValidationMessageFor(m => m.ShiYongDiDian)%>--%>    
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (formMode != "new" && formMode != "new2") {
                var isStartDepreciation = '<%=Model.IsStartDepreciation%>';
                if (isStartDepreciation && isStartDepreciation == "Y") {
                    var depreciationRule = '<%=Model.DepreciationRule%>';
                    if (depreciationRule) {
                        $('#DepreciationRule' + pageId).attr('disabled', true);
                    }

                    var assetsValue = '<%=Model.AssetsValue%>';
                    if (assetsValue > 0) {
                        $('#AssetsValue' + pageId).attr('disabled', true);
                    }

//                    var purchaseDate2 = '<%=Model.PurchaseDate2%>';
//                    if (purchaseDate2) {
//                        $('#PurchaseDate2' + pageId).attr('disabled', true);
//                    }
                }
            }
            //#endregion 初始化处理
...
<asp:Content ID="Content4" ContentPlaceHolderID="TabsDivContent" runat="server">
    <div id='tabs-addition-<%=Model.PageId%>'>
        <div class="editor-field" style="height: 310px;">
            <div class="fieldwidth3">
                <%:Html.AppLabelFor(m => m.ImgFileDefault, Model.PageId,"AssetsEntry")%>
            </div>
            <div class="fieldwidth4" style="width: 600px; height: 300px">
                <fieldset>
                    <img id="assetsImg<%=Model.PageId%>" alt="" style="width: 450px; height: 280px" src='<%= Url.Content(DataConvert.ToString( Model.ImgFileDefault)==""?"~/Content/images/imgnull.jpg":"~/Content/uploads/assets/"+Model.ImgFileDefault)%>' />
                </fieldset>
            </div>
        </div>
        <div class="editor-field" style="height: 25px;">
            <div class="AssetsEntryColumn3">
            </div>
