...
{
    public class FiscalPeriodController : MasterController
    {
        FiscalPeriodRepository Repository;
        public FiscalPeriodController()
        {
            ControllerName = "FiscalPeriod";
            CacheExpiryMinute = 5;
        ...
        public ActionResult List(string pageId, string viewTitle )
        {
            ...
            model.GridPkField = "fiscalPeriodId";
            return View(model);
        }
        ...
        public ActionResult Entry(EntryModel model)
        {
            ...
            //{
            //    Update(EntryRepository, model, model.FormMode, model.FiscalPeriodId, model.ViewTitle);
              
            //}
            //return View(model);
            if (Update(Repository, model, model.FiscalPeriodId) == 1)
            {
