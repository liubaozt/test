...
{
    public class AssetsSplitQueryController : QueryController
    {

        public AssetsSplitQueryController()
        {
            ControllerName = "AssetsSplitQuery";
            Repository = new AssetsSplitQueryRepository();
        }
