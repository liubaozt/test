...
{
    public class AssetsMaintainQueryController : QueryController
    {

        public AssetsMaintainQueryController()
        {
            ControllerName = "AssetsMaintainQuery";
            Repository = new AssetsMaintainQueryRepository();
        }
