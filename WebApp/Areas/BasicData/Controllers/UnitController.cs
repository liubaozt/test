...
{
    public class UnitController : MasterController
    {
        ...
        protected override IMasterFactory CreateRepository()
        {
            ...
            return new MasterRepositoryFactory<UnitRepository>(Repository);
        }
        ...
        public ActionResult Entry(EntryModel model)
        {
            ...
            //{
            //    Update(EntryRepository, model, model.FormMode, model.UnitId, model.ViewTitle);
            //}
            //return View(model);
            if (Update(Repository, model, model.UnitId) == 1)
            {
