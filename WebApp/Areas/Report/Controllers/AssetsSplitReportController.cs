...
using BusinessLogic.Report.Models.AssetsSplitReport;
...
{
    public class AssetsSplitReportController : QueryReportController
    {

        public AssetsSplitReportController()
        {
            ControllerName = "AssetsSplitReport";
            Repository = new AssetsSplitReportRepository();
        }
        ...
        public ActionResult Entry(string pageId, string primaryKey, string viewTitle)
        {
            ...
            model.EntryGridTitle = AppMember.AppText["AssetsSplitReport"].ToString();
