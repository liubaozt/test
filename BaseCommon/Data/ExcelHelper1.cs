     ...
     public class ExcelHelper1
     {
         ...
         public void DataTableToExcel(System.Data.DataTable dt,int rows,int top,int left,string sheetPrefixName)
         {
            ...
            // Excel.Application app = new Excel.ApplicationClass();
             Microsoft.Office.Interop.Excel.Application app = new Microsoft.Office.Interop.Excel.Application();  //Execl的操作类
             //app.Visible = true;
             ...
             Excel.Workbook workBook = app.Workbooks.Add(missing);
