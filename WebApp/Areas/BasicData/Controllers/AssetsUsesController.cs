...
{
    public class AssetsUsesController : MasterController
    {
        AssetsUsesRepository Repository;
        public AssetsUsesController()
        {
            ControllerName = "AssetsUses";
            CacheExpiryMinute = 5;
        ...
        protected override IMasterFactory CreateRepository()
        {
            ...
            return new MasterRepositoryFactory<AssetsUsesRepository>(Repository);
        }
        ...
        public ActionResult List(string pageId, string viewTitle)
        {
            ...
            model.GridPkField = "assetsUsesId";
            return View(model);
        }
        ...
        public ActionResult Entry(EntryModel model)
        {
            ...
            //{
            //    Update(EntryRepository, model, model.FormMode, model.AssetsUsesId, model.ViewTitle);
              
            //}
            //return View(model);
            if (Update(Repository, model, model.AssetsUsesId) == 1)
            {
