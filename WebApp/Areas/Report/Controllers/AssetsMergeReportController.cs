...
{
    public class AssetsMergeReportController : QueryReportController
    {

        public AssetsMergeReportController()
        {
            ControllerName = "AssetsMergeReport";
            Repository = new AssetsMergeReportRepository();
        }
        ...
        public ActionResult Entry(string pageId, string primaryKey, string viewTitle)
        {
            ...
            model.EntryGridTitle = AppMember.AppText["AssetsMergeReport"].ToString();
